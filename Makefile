...
mk_COptions = -c -Wall -Wmissing-prototypes -Wstrict-prototypes -Wno-uninitialized -Os

TheDefaultOutput : minivmac

bld/MYOSGLUE.o : src/MYOSGLUE.c src/PLATGLUE.h src/STRCONST.h src/CONTROLM.h src/CNFGGLOB.h
	gcc "src/MYOSGLUE.c" -o "bld/MYOSGLUE.o" $(mk_COptions) `pkg-config --cflags gtk+-2.0`
